...
const char* ssid     = "NETGEAR70";                 // SSID of local network
const char* password = "windypiano374";                    // Password on network
String APIKEY = "757bd434f63deb227b008cb3864aa575";
String CityID = "1819730";          //Your City ID
bool id = false;
WiFiClient client;
...
//  Serial.println(timeClient.getFormattedTime()); // - First Option
  formattedTime = timeClient.getFormattedTime(); // - First Option
